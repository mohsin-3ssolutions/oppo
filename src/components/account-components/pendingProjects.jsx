...
export default function PendingProjects() {
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await fetch(
                url + `/sub_cont_pending_project?page_num_start=1&page_size=20`,
                requestOptions
            );
    ...
    const fetchPaginatedData = async (currentPage) => {
        ...
        const res = await fetch(
            url +
            `/sub_cont_pending_project?page_num_start=1&page_size=20`,
            requestOptions
        );
                                            ...
                                            <li>
                                                <div className="project_detail">
                                                    <div className="project_head">
                                                        <h2>{item.project_name} <span>Awarded on Oct 2, 2023</span></h2>
                                                    </div>
