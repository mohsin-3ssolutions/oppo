...
export default function SCawardproposal() {
    return (
        <DefaultLayout>
            <div>
                    ...
                    <div className='container'>
                        <div className="color_bg mb-0">
                            ...
                            <div className='submit_banner mt-5'>
                                <h3 className='sub_head'>Awarded Proposal</h3>
                                    ...
                                    <li>
                                        <div className='propocal_card dropdown'>
                                                    ...
                                                    <div className='row'>
                                                        ...
                                                        <div className='col-lg-6'>
                                                            <div className='proposal_content proposal_detail'>
                                                                ...
                                                                <h2 className='text-center mt-3'>Project Awarded Nov 1, 2023</h2>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div className='comunication_content '>
                                                <div className='proposal_content'>
                                                    <p><strong>Latest Communication</strong></p>
